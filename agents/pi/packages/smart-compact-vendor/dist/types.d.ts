...
export type TelemetryFailureKind = "cancelled" | "timeout" | "rate-limit" | "authentication" | "budget" | "output-limit" | "provider" | "persistence" | "validation" | "verification" | "yield" | "internal";
