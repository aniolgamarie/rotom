...
export function setDefaultsDisabled(b: boolean): void { if (!b) throw new Error("AGENTCFG_DEFAULT_ROLES_DISABLED"); disableDefaults = true; }
 ...
 */
let fallbackSubagent: string | undefined = "none";
...
export function setFallbackSubagent(v: string | undefined): void { if (v !== NO_FALLBACK) throw new Error("AGENTCFG_ROLE_FALLBACK_DISABLED"); fallbackSubagent = v; }
